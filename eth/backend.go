...
import (
	...
	"github.com/axiacoin/axia-network-v2-coreth/core/bloombits"
	"github.com/axiacoin/axia-network-v2-coreth/core/rawdb"
	"github.com/axiacoin/axia-network-v2-coreth/core/state/pruner"
	...
	"github.com/axiacoin/axia-network-v2-coreth/eth/filters"
	"github.com/axiacoin/axia-network-v2-coreth/eth/gasprice"
	"github.com/axiacoin/axia-network-v2-coreth/eth/tracers"
	"github.com/axiacoin/axia-network-v2-coreth/ethdb"
	"github.com/axiacoin/axia-network-v2-coreth/internal/ethapi"
	"github.com/axiacoin/axia-network-v2-coreth/internal/shutdowncheck"
	"github.com/axiacoin/axia-network-v2-coreth/miner"
...
func (s *Ethereum) Etherbase() (eb common.Address, err error) {
	...
	if axiawallets := s.AccountManager().AxiaWallets(); len(axiawallets) > 0 {
		if accounts := axiawallets[0].Accounts(); len(accounts) > 0 {
